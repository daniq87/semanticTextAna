...
class DefaultController extends Controller {
    ...
    public function createCustomForm($route,$routeParameters, $method) {
        return $this->createFormBuilder()
                        ->setAction($this->generateUrl($route, $routeParameters))
                        ->setMethod($method)
                        ->getForm();
    }
     ...
     * @param type $entity The entity to check
     * @param type $nameEntity The name of the entity to show in the message exception
